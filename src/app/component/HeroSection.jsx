...
const HeroSection = () => {
  return (
    ...
    />
       ...
       <p className='text-[#ADB7BE] text-base sm:text-lg lg:text-xl mb-6'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolor aliquam 
       </p>
        <div>
          ...
          <button className='px-1 py-1 w-full sm:w-fit rounded-full  bg-gradient-to-br from-primary-500 to-secondary-500 hover:bg-slate-800 text-white  mt-3'>
            <span className='className="block bg-[#121212] hover:bg-slate-800 rounded-full px-5 py-2'>Download Cv
            </span>
            </button>
        </div>
